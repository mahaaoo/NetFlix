...
struct Constants {
    static let API_KEY = "ffa99505c028a4f2dfa048dea15b3e86"
    static let baseURL = "https://api.tmdb.org"
...
class APICaller {
    ...
    func getPopularMoives(completion: @escaping (Result<[Title], Error>) -> Void) {
